...
nx-success button { width: 100%; padding: 14px; border-radius: 999px; background: #18443e; color: #fff; font-weight: 600; font-size: 15px; border: none; cursor: pointer; }
    ...
    /* ====================================================================
     * BANK ACCOUNT — verify via nualt API (proxied through /api/resolve,
     * which reads NUALT_API_KEY from the server env — nu-alt.shop has no
     * CORS support, so calling it directly from the browser 405s on the
     * preflight OPTIONS request every time) + save to localStorage
     * ==================================================================== */
